            ...
            {props.wikiItems.map((wikiItem) => (
                <div key={wikiItem.id} className="group relative wiki-item-container" onClick={e => changeStyle(e.currentTarget)}>
                    <div className="min-h-80  w-full overflow-hidden rounded-md bg-[#1D1E20] group-hover:opacity-75 lg:aspect-none lg:h-80">
                        <h2 className="text-2xl font-bold tracking-tight text-gray-900 wiki-item-title">{wikiItem.name}</h2>
                        ...
                        <div className="wiki-item-description-container">
                            <p className="item-description text-2xl font-bold tracking-tight text-gray-900 wiki-item-title">{wikiItem.detail1}</p>
                            <p className="item-description text-2xl font-bold tracking-tight text-gray-900 wiki-item-title">{wikiItem.detail2}</p>
                        </div>                        
                    </div>
                </div>
            ))}
